...
- Configure an analysis with visible server-controlled assumptions, review the exact request in a dialog, follow its server-owned lifecycle, and inspect Overview, Hypothetical trades, Equity data, and Methodology tabs without client-side calculation.
