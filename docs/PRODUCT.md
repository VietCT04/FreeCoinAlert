...
- Configure an analysis with server-controlled assumptions available from the Info dialog, review the request in a dialog, follow its lifecycle, and inspect Overview, Hypothetical trades, Equity data, and Methodology tabs without client-side calculation.
