...
Schema contents were read from the SQLAlchemy registry and Alembic chain. The new open-position migration was not applied in this change; rollback, schema-diff, and production migration behavior remain unverified.
