...
Alert price values remain exact decimal strings at the API boundary. The browser removes only insignificant fractional trailing zeros for display, without binary floating-point conversion or rounding; for example, `65059.000000000000000000` displays as `65059` and `0.0000251500000` displays as `0.00002515`.
