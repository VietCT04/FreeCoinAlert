...
- Historical-analysis price-action visualization is implemented on the current branch and awaits review, merge, and a maintainer-requested verification pass. The user story is [US-0012](user-stories/US-0012-visualize-historical-analysis-price-action.md), tracked by GitHub Issue `#131`.
