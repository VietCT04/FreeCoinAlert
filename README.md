...
- A pinned Playwright workspace with deterministic desktop/mobile feature-journey projects, named historical-analysis fixtures, worker gates, recovery controls, bounded accessibility attachments, and a dependency-free isolated E2E runner that owns startup, safe failure artifacts, and teardown; the current route/action matrix is in [E2E_COVERAGE.md](docs/E2E_COVERAGE.md), and all browser/runtime behavior is Unverified.
