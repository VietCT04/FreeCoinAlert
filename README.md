...
- Repository-owned shadcn/ui primitives, shared presentational components, light/dark/system theme selection, and the single browser provider boundary; current feature panels and routes remain unchanged.
