...
- `/historical-analysis` — a guided Configure, Processing, Results flow with responsive previous-run selection, three focused report tabs, a server-owned Recharts equity preview, and a bounded candlestick preview with hypothetical trade markers.
