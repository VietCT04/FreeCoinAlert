...
- `/historical-analysis` — a guided Configure, Processing, Results flow with responsive previous-run selection, server-owned report tabs, a Recharts equity preview, and accessible table alternatives.
