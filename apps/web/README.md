...
- `/historical-analysis` — a guided Configure, Processing, Results flow with responsive previous-run selection, three focused report tabs, and a server-owned Recharts equity preview.
